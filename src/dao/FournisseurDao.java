...
public class FournisseurDao {
	...
	private static final Log log = LogFactory.getLog(FournisseurDao.class);
	...
	public Fournisseur findById(java.lang.String id) {
		log.debug("getting Fournisseur instance with id: " + id);
		try {
			Fournisseur instance = (Fournisseur) sessionFactory
					.getCurrentSession().get("dao.Fournisseur", id);
			if (instance == null) {
	...
	public List findByExample(Fournisseur instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("dao.Fournisseur")
